...
def evaluation(video, selectedVideoFrames):
    [f_measure, summary_length] = evaluateSummary(selectedVideoFrames, video, HOMEDATA)
...
#
#     nFrames = np.asarray(gt_data.get('nFrames')).reshape(1)[0]
#
